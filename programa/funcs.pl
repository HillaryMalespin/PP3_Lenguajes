...
generar_itinerario_por_monto :- 
    ...
    preguntar_satisfaccion_monto(CostoTotal, CategoriaPreferida, CantidadPersonas, OpcionEstancia).
...
preguntar_satisfaccion_monto(CostoTotal, CategoriaPreferida, CantidadPersonas, OpcionEstancia) :-
    ...
    ; 
        write('Generando un nuevo itinerario con categoria afin...'), nl,
        generar_itinerario_con_categoria_afina_monto(CostoTotal, CategoriaPreferida, CantidadPersonas, OpcionEstancia)
    ).
 ...
 ***************************************************/
generar_itinerario_con_categoria_afina_monto(CostoMaximo, CategoriaPreferida, CantidadPersonas, OpcionEstancia) :-
